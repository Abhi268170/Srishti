...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { body: @query.body, email: @query.email, name: @query.name, projects_id: @query.projects_id } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { body: @query.body, email: @query.email, name: @query.name, projects_id: @query.projects_id } }
